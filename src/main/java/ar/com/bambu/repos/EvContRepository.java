...
public interface EvContRepository extends JpaRepository<EvCont, EvContId> {
    ...
    @Query(value = "select new ar.com.bambu.entities.EvCont (ev, art.nombre as articuloName) from EvCont ev join Articulo art on ev.codArticulo=art.codInterno where ev.idEvento=:idEvento")
